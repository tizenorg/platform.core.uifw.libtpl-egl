...
export GTEST_DIR="%{_builddir}/%{buildsubdir}/tc/gtest/googletest/googletest"
...
cp -a %{_builddir}/%{buildsubdir}/tc/gtest/googletest/googletest/LICENSE %{buildroot}/%{TZ_SYS_RO_SHARE}/license/googletest

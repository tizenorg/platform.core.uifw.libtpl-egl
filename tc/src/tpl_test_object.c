...
bool tpl_object_get_type_test(TPLNativeWnd* wnd )
{
    ...
    obj_type = -1;
    obj_type = tpl_object_get_type((tpl_object_t *)tpl_surf);
    ...
    obj_type = -1;
    obj_type = tpl_object_get_type((tpl_object_t *)tpl_buf);
...
bool tpl_object_userdata_test(TPLNativeWnd* wnd )
{
    ...
    //2. set userdate
    tpl_object_set_user_data((tpl_object_t *)tpl_display,(void *)wnd->dpy,NULL);

...
TEST_F(TPLTest, tpl_object_userdata_test) {
    ...
    // set user data
    tpl_object_set_user_data((tpl_object_t *)tpl_display, &key, (void *)wl_disp.display, NULL);

    // get user data
    void* get_dpy = NULL;
    get_dpy = (void *)tpl_object_get_user_data((tpl_object_t *)tpl_display, &key);

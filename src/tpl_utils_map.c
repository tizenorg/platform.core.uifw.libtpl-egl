...
{
	tpl_util_map_init(map, bucket_bits, __pointer_hash, NULL, __pointer_key_compare, buckets);
}
...
{
	return tpl_util_map_create(bucket_bits, __pointer_hash, NULL, __pointer_key_compare);
}

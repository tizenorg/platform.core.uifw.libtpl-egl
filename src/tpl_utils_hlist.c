...
static inline void __tpl_hlist_init_node(tpl_hlist_node_t *n);
static inline int __tpl_hlist_empty(const tpl_hlist_head_t *h);
static inline void __tpl_hlist_del(tpl_hlist_node_t *n);
static inline void __tpl_hlist_add_head(tpl_hlist_node_t *n, tpl_hlist_head_t *h);
static inline void __tpl_hlist_add_before(tpl_hlist_node_t *n, tpl_hlist_node_t *next);
static inline void __tpl_hlist_add_behind(tpl_hlist_node_t *n, tpl_hlist_node_t *prev);
